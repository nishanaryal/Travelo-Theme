...
if ( ! function_exists( 'trav_acc_vacancy_add_menu_items' ) ) {
	function trav_acc_vacancy_add_menu_items() {
		$page = add_submenu_page( 'edit.php?post_type=accommodation', 'Accommodation Vacancies', 'Vacancies', 'edit_accommodations', 'vacancies', 'trav_acc_vacancy_render_pages' );
...
if ( ! function_exists( 'trav_acc_vacancy_render_list_page' ) ) {
	function trav_acc_vacancy_render_list_page() {
		...
		<div class="wrap">
			<h2>Accommodation Vacancies <a href="edit.php?post_type=accommodation&amp;page=vacancies&amp;action=add" class="add-new-h2">Add New</a></h2>
			...
			<a href="edit.php?post_type=accommodation&amp;page=vacancies" class="button-secondary">Show All</a>
...
if ( ! function_exists( 'trav_acc_vacancy_render_manage_page' ) ) {
	function trav_acc_vacancy_render_manage_page() {
		...
		if ( 'add' == $_REQUEST['action'] ) {
			$page_title = "Add New Accommodation Vacancy";
		} elseif ( 'edit' == $_REQUEST['action'] ) {
			$page_title = 'Edit Accommodation Vacancy<a href="edit.php?post_type=accommodation&amp;page=vacancies&amp;action=add" class="add-new-h2">Add New</a>';
		...
		<div class="wrap">
			...
			<form method="post" onsubmit="return manage_vacancy_validateForm();">
				...
				<a href="edit.php?post_type=accommodation&amp;page=vacancies" class="button-secondary">Cancel</a>
	...
	function trav_acc_vacancy_save_action() {
		...
		if ( ! isset( $_POST['vacancy_save'] ) || ! wp_verify_nonce( $_POST['vacancy_save'], 'trav_acc_vacancy_manage' ) ) {
		   ...
		   exit;
			...
			$default_vacancy_data = array( 'accommodation_id'  => '',
										'room_type_id'      => '',
										'rooms'        => 0,
										'date_from'        => date( 'Y-m-d' ),
										'date_to'          => '9999-12-31',
